...
if __name__ == "__main__":
    ...
    # ap.add_argument('--reps', default=5, type=int, help="Number of contiguous times to repeat each control matrix comb")
    ...
    eM = ExperimentManager(phase_mat_list, amplitude_mat_list, "constant_delta_scanning.csv", run_duration=0.5)
    eM.start()